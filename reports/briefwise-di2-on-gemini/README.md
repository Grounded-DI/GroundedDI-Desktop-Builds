...
The report examines that contrast, errors in **both** answers, and Gemini’s subsequent acknowledgments. It includes source-linked findings about authority mapping, unsupported facts, quotation accuracy and verification claims.

## Read the comparison accurately

- Both conditions used Gemini cloud inference. The comparison concerns BriefWise DI² on Gemini and a Gemini control instructed to simulate BriefWise DI².
- This is one illustrative comparison. Model settings, tools and conversation histories were not established as equivalent; it does not establish reliable superiority or causation.
- Proprietary material is redacted and outside the analysis. Published excerpts are not complete original transcripts, and the underlying implementation is not characterized here.
...
When sharing, link to this page so readers can reach the report and its scope notes. Suggested description: **“BriefWise DI² on Gemini: a cross-engine legal drafting example, a revealing control, and a candid audit of both answers.”**
